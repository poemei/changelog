        ...
        <form action="/admin/changelog" method="POST">
            ...
            <div style="display: grid; grid-template-columns: 1fr 1fr 1fr; gap: 20px;">
                <div class="form-group">
                    ...
                    <input type="text" name="version" maxlength="20" placeholder="v1.0.0"
                        value="<?= htmlspecialchars((string) ($data['edit_item']['version'] ?? ''), ENT_QUOTES, 'UTF-8') ?>" required>
                </div>
                <div class="form-group">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td style="text-align:right; white-space:nowrap;">
                        ...
                        <form action="/admin/changelog" method="POST" style="display:inline"
